...
Logistinio skirstinio momentų metodo įvertiniai išvedami iš teorinių skirstinio momentų. Žinome, kad logistinio skirstinio su parametrais μ (location) ir σ (scale):
- Vidurkis = μ
- Dispersija = π²σ²/3

Taigi, momentų metodo įvertiniai yra:
- μ̂ = x̄ (imties vidurkis)
- σ̂ = √(3s²/π²), kur s² yra imties dispersija
